...
{#4}\nobreak
\leaders\hbox{$\m@th
\mkern \@dotsep mu\hbox{\ifnum0=#1 \bf\fi.}\mkern \@dotsep
mu$}\hfill
\nobreak
\hb@xt@\@pnumwidth{\hfil \normalfont \normalcolor \ifnum0=#1 \bf\fi#5}%目录层为1时，页码粗体
\par}%
\fi}

\renewcommand*\l@chapter{\@dottedtoclinebold{0}{0em}{4em}}% 控制英文目录： 细点\@dottedtocline  粗点\@dottedtoclinebold
...
\def\engcontentsname{\bfseries English Catalog}
\newcommand\tableofengcontents{
   \pdfbookmark[0]{English Catalog}{English Catalog}
     \@restonecolfalse

...
\addcontentsline{toe}{chapter}{\bfseries \xiaosi \thechapter\hspace{0.5em} {\boldmath #3}}}
\def\@@BiChapter#1#2{\chapter{#1}
    \addcontentsline{toe}{chapter}{\bfseries \xiaosi \thechapter\hspace{0.5em}{\boldmath #2}}}
...
{\phantomsection  
  \chapter{#1}   %\markboth{\MakeUppercase{#1}}{\MakeUppercase{#1}} %为了winedt中project tree 中toc正确显示，不要挪到下一行；
